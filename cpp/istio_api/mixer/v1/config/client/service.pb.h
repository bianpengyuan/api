...
#ifndef PROTOBUF_INCLUDED_mixer_2fv1_2fconfig_2fclient_2fservice_2eproto
#define PROTOBUF_INCLUDED_mixer_2fv1_2fconfig_2fclient_2fservice_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_mixer_2fv1_2fconfig_2fclient_2fservice_2eproto 
...
namespace google {
namespace protobuf {
template<> ::istio::mixer::v1::config::client::IstioService* Arena::CreateMaybeMessage<::istio::mixer::v1::config::client::IstioService>(Arena*);
template<> ::istio::mixer::v1::config::client::IstioService_LabelsEntry_DoNotUse* Arena::CreateMaybeMessage<::istio::mixer::v1::config::client::IstioService_LabelsEntry_DoNotUse>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace istio {
namespace mixer {
...
class IstioService : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:istio.mixer.v1.config.client.IstioService) */ {
 public:
  ...
  inline IstioService* New() const final {
    return CreateMaybeMessage<IstioService>(NULL);
  }

  IstioService* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<IstioService>(arena);
  }
...
#endif  // PROTOBUF_INCLUDED_mixer_2fv1_2fconfig_2fclient_2fservice_2eproto
