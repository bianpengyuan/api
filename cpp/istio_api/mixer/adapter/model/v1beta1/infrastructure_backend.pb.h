...
#ifndef PROTOBUF_INCLUDED_mixer_2fadapter_2fmodel_2fv1beta1_2finfrastructure_5fbackend_2eproto
#define PROTOBUF_INCLUDED_mixer_2fadapter_2fmodel_2fv1beta1_2finfrastructure_5fbackend_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_mixer_2fadapter_2fmodel_2fv1beta1_2finfrastructure_5fbackend_2eproto 
...
namespace google {
namespace protobuf {
template<> ::istio::mixer::adapter::model::v1beta1::CloseSessionRequest* Arena::CreateMaybeMessage<::istio::mixer::adapter::model::v1beta1::CloseSessionRequest>(Arena*);
template<> ::istio::mixer::adapter::model::v1beta1::CloseSessionResponse* Arena::CreateMaybeMessage<::istio::mixer::adapter::model::v1beta1::CloseSessionResponse>(Arena*);
template<> ::istio::mixer::adapter::model::v1beta1::CreateSessionRequest* Arena::CreateMaybeMessage<::istio::mixer::adapter::model::v1beta1::CreateSessionRequest>(Arena*);
template<> ::istio::mixer::adapter::model::v1beta1::CreateSessionRequest_InferredTypesEntry_DoNotUse* Arena::CreateMaybeMessage<::istio::mixer::adapter::model::v1beta1::CreateSessionRequest_InferredTypesEntry_DoNotUse>(Arena*);
template<> ::istio::mixer::adapter::model::v1beta1::CreateSessionResponse* Arena::CreateMaybeMessage<::istio::mixer::adapter::model::v1beta1::CreateSessionResponse>(Arena*);
template<> ::istio::mixer::adapter::model::v1beta1::ValidateRequest* Arena::CreateMaybeMessage<::istio::mixer::adapter::model::v1beta1::ValidateRequest>(Arena*);
template<> ::istio::mixer::adapter::model::v1beta1::ValidateRequest_InferredTypesEntry_DoNotUse* Arena::CreateMaybeMessage<::istio::mixer::adapter::model::v1beta1::ValidateRequest_InferredTypesEntry_DoNotUse>(Arena*);
template<> ::istio::mixer::adapter::model::v1beta1::ValidateResponse* Arena::CreateMaybeMessage<::istio::mixer::adapter::model::v1beta1::ValidateResponse>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace istio {
namespace mixer {
...
class ValidateRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:istio.mixer.adapter.model.v1beta1.ValidateRequest) */ {
 public:
  ...
  inline ValidateRequest* New() const final {
    return CreateMaybeMessage<ValidateRequest>(NULL);
  }

  ValidateRequest* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<ValidateRequest>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) final;
  void MergeFrom(const ::google::protobuf::Message& from) final;
...
class ValidateResponse : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:istio.mixer.adapter.model.v1beta1.ValidateResponse) */ {
 public:
  ...
  inline ValidateResponse* New() const final {
    return CreateMaybeMessage<ValidateResponse>(NULL);
  }

  ValidateResponse* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<ValidateResponse>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) final;
  void MergeFrom(const ::google::protobuf::Message& from) final;
...
inline const ::google::protobuf::Any& CreateSessionRequest::_internal_adapter_config() const {
...
inline const ::google::rpc::Status& CreateSessionResponse::_internal_status() const {
  return *status_;
}
...
inline const ::google::protobuf::Any& ValidateRequest::_internal_adapter_config() const {
  return *adapter_config_;
}
...
inline const ::google::rpc::Status& ValidateResponse::_internal_status() const {
  return *status_;
}
...
inline const ::google::rpc::Status& CloseSessionResponse::_internal_status() const {
  return *status_;
}
...
#endif  // PROTOBUF_INCLUDED_mixer_2fadapter_2fmodel_2fv1beta1_2finfrastructure_5fbackend_2eproto
